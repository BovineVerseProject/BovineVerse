...
module test_coin_admin::test_coins {
    ...
    public fun register_coins(coin_admin: &signer) {
        ...
        let (bvt_burn_cap, bvt_freeze_cap, bvt_mint_cap) =
            coin::initialize<BVT>(
                coin_admin,
                utf8(b"BVT"),
                utf8(b"BVT"),
        ...
        move_to(coin_admin, Capabilities<BVT> {
            mint_cap: bvt_mint_cap,
            burn_cap: bvt_burn_cap,
        });

        coin::destroy_freeze_cap(bvt_freeze_cap);
    }
